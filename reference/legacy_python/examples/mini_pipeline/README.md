...
```bash
# 端到端 CLI
PYTHONPATH=<esl_repo>/reference/legacy_python uv run --project . python <esl_repo>/tools/esl_cli.py run <esl_repo>/reference/legacy_python/examples/mini_pipeline/system.yaml
PYTHONPATH=<esl_repo>/reference/legacy_python uv run --project . python <esl_repo>/tools/esl_cli.py sweep <esl_repo>/reference/legacy_python/examples/mini_pipeline/experiment.yaml
# T 系列测试
PYTHONPATH=<esl_repo>/reference/legacy_python uv run --project . python <esl_repo>/reference/legacy_python/examples/mini_pipeline/tests/test_t01_t03.py
```
