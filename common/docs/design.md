...
实现按 primitives/infrastructure/adapters/services/workloads/verification 分层；common 只聚合构建、manifest 和文档，不保留旧头文件副本。公开 include 名称保持 aix/esl/<name>.hpp，目录分层不产生第二个 SystemC 内核。
