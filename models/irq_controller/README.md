...
源码位于 systemc/include/irq_controller 与 systemc/src；文档位于 docs。专项测试与外部消费者共用 [interrupt_system](../../examples/interrupt_system/README.md)，避免复制测试顶层。该入口同时承担 standalone/源码/安装集成测试。
