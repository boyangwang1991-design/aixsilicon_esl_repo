...
仅链接 AixEslCommon / aix::esl::common，不依赖任何具体模型。46 个 SystemC 场景验证基础组件、资源与服务、闭环任务和多 Bank 组合，见 [验证映射](../../common/docs/verification.md)。构建/安装命令见 [集成](../../common/docs/integration.md)。
